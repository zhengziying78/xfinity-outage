...
class TestAggregateByInterval:
    ...
    def test_aggregate_by_interval_single_data_point(self, mock_print):
        ...
        assert result[0] == (expected_time, 0.8)
    ...
    def test_aggregate_by_interval_multiple_same_interval(self, mock_print):
        ...
        assert result[0] == (expected_time, expected_avg)
        mock_print.assert_called_once_with("Aggregated into 1 15-minute intervals")
    ...
    def test_aggregate_by_interval_multiple_intervals(self, mock_print):
        ...
        assert result[0] == (datetime.datetime(2025, 7, 10, 12, 15), 0.8)
        assert result[1] == (datetime.datetime(2025, 7, 10, 12, 30), 0.6)
        assert result[2] == (datetime.datetime(2025, 7, 10, 12, 45), 1.0)
    ...
    def test_aggregate_by_interval_custom_interval(self, mock_print):
        ...
        assert len(result) == 3
        assert result[0] == (datetime.datetime(2025, 7, 10, 12, 10), 0.8)
        assert result[1] == (datetime.datetime(2025, 7, 10, 12, 20), 0.6)
        assert result[2] == (datetime.datetime(2025, 7, 10, 12, 30), 1.0)
    ...
    def test_aggregate_by_interval_hour_boundaries(self, mock_print):
        ...
        assert result[0] == (datetime.datetime(2025, 7, 10, 12, 0), 0.8)   # 11:55 rounds to 11:45, +15 = 12:00
        assert result[1] == (datetime.datetime(2025, 7, 10, 12, 15), 0.6)  # 12:05 rounds to 12:00, +15 = 12:15
        assert result[2] == (datetime.datetime(2025, 7, 10, 12, 45), 1.0)  # 12:35 rounds to 12:30, +15 = 12:45
    ...
    def test_aggregate_by_interval_edge_case_values(self, mock_print):
        ...
        assert result[0] == (datetime.datetime(2025, 7, 10, 12, 15), 0.5)
        # Second interval: just 0.5
        assert result[1] == (datetime.datetime(2025, 7, 10, 12, 30), 0.5)
    ...
    def test_aggregate_by_interval_large_interval(self, mock_print):
        ...
        assert result[0] == (datetime.datetime(2025, 7, 10, 13, 0), expected_avg_first)
        assert result[1] == (datetime.datetime(2025, 7, 10, 14, 0), 1.0)
    ...
    def test_aggregate_by_interval_one_minute_interval(self, mock_print):
        ...
        expected_avg_first = (0.8 + 0.6) / 2
        assert result[0] == (datetime.datetime(2025, 7, 10, 12, 6), expected_avg_first)
        assert result[1] == (datetime.datetime(2025, 7, 10, 12, 7), 1.0)
